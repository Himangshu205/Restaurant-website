#This is a basic e-commerce website that I built when I was just starting out with JavaScript. At the time, the project mainly focused on understanding core JavaScript concepts such as event handling (onclick), and DOM manipulation.
